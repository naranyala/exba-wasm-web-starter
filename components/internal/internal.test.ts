...
describe('Internal Component Suite', () => {
  ...
  describe('TabBar Component', () => {
    it('should render tabs and home button', () => {
      document.body.innerHTML = '<tab-bar id="test-tab-bar" data-testid="tab-bar"></tab-bar>';
  ...
  describe('StatusBar Component', () => {
    it('should render primitives and wasm-functions count', () => {
      document.body.innerHTML = '<status-bar data-testid="status-bar" primitives="5" wasm-functions="12"></status-bar>';
    ...
    it('should subscribe and react to global counter changes', () => {
      document.body.innerHTML = '<status-bar data-testid="status-bar"></status-bar>';
  ...
  describe('WasmModal Component', () => {
    ...
    it('should remove itself when backdrop is clicked', () => {
      document.body.innerHTML = '<div id="parent"><wasm-modal data-testid="modal"></wasm-modal></div>';

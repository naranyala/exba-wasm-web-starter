...
/**
 * A stylized neofetch-like component that displays system diagnostics.
 * 
 * Demonstrates real-time integration with the WASM core to retrieve 
 * hardware and environment information (OS, Browser, CPU, RAM, etc.)
 * through the `SystemFetch` IR command.
 * 
...
export class NeofetchComponent extends ExbaComponent {
  ...
  /**
   * Fetches system information from the WASM bridge on mount.
   */
  ...
  /**
   * Renders the neofetch card with ASCII logo and system details.
   */
  render() {

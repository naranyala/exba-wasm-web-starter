...
export class BatteryDemo extends ExbaComponent {
  static styles = {
    ...
    levelWrapper: 'position: relative; width: 120px; height: 180px; border: 4px solid #3f3f46; border-radius: 12px; padding: 4px;',
    levelFill: 'width: 100%; background: #22c55e; border-radius: 4px; position: absolute; bottom: 4px; left: 4px; right: 4px; transition: height 0.5s ease;',
...
customElements.define('exba-battery-demo', BatteryDemo);

...
describe('Widgets Component Suite', () => {
  ...
  describe('AccordionComponent', () => {
    it('should render accordion header and items', () => {
      document.body.innerHTML =
        '<exba-accordion data-testid="accordion"></exba-accordion>';
  ...
  describe('DrawerComponent', () => {
    it('should open and close drawer', () => {
      document.body.innerHTML =
        '<exba-drawer data-testid="drawer"></exba-drawer>';
  ...
  describe('DatePickerComponent', () => {
    it('should render datepicker and change months', () => {
      document.body.innerHTML =
        '<exba-datepicker data-testid="datepicker"></exba-datepicker>';
      ...
      expect(shadow.querySelector('.monthTitle')?.textContent).toBe(
        initialMonth,
      );
    });
  ...
  describe('ExbaGreeting', () => {
    it('should render custom name', () => {
      document.body.innerHTML =
        '<exba-greeting data-testid="greeting" name="Developer"></exba-greeting>';
      const el = screen.getByTestId('greeting');
      expect(el).toBeDefined();

      const shadow = el.shadowRoot!;
      expect(shadow.innerHTML).toContain(
        'Hello, <span class="highlight">Developer</span>! Welcome to EXBA Framework.',
      );
    });
  });
});
